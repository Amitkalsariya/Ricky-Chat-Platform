...
const HomePage = () => {
  ...
  return (
    <div className='h-[100dvh] bg-base-200/50 overflow-hidden'>
      {/* Full viewport layout — mobile: edge-to-edge, desktop: centered card */}
      <div className='flex items-center justify-center pt-[3.5rem] sm:pt-[4rem] md:pt-[4.5rem] px-0 md:px-4 h-[100dvh]'>
        <div className='bg-base-100 rounded-none md:rounded-2xl shadow-xl shadow-base-content/5 border-0 md:border md:border-base-200/80 w-full max-w-6xl h-full'>
